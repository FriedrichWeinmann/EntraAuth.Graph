...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\EntraAuth.Graph\functions", "$global:testroot\..\EntraAuth.Graph\internal\functions"),
	
	[string]
	$ModuleName = "EntraAuth.Graph",
...
$CommandPath = @(
    "$global:testroot\..\EntraAuth.Graph\functions"
    "$global:testroot\..\EntraAuth.Graph\internal\functions"
)

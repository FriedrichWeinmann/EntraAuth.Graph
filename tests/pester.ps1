...
Remove-Module EntraAuth.Graph -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\EntraAuth.Graph\EntraAuth.Graph.psd1"
Import-Module "$PSScriptRoot\..\EntraAuth.Graph\EntraAuth.Graph.psm1" -Force
